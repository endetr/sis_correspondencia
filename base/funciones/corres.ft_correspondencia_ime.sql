     ...
     --1)obtiene el identificador de la gestion
      ...
      --3 Sentencia de la insercion
        insert into corres.tcorrespondencia(estado,estado_reg, fecha_documento,
                    ...
                    --id_clasificador,  --#4
                    id_correspondencias_asociadas,fecha_creacion_documento,
                    persona_destino,  --#4
                    fecha_envio) --#4
        values ( 'borrador_envio','activo',
              ...
              -- now()::date,
               ...
               v_id_periodo,
               NULL,--v_parametros.id_persona_destino, --#4
               ...
               --v_parametros.id_clasificador,  --#4
               case when v_parametros.id_correspondencias_asociadas='' THEN
                                                       NULL
                                                 ELSE
                string_to_array(v_parametros.id_correspondencias_asociadas, ',')::integer [ ]
                END,
                now(),
                v_parametros.persona_destino, --#4
                v_parametros.fecha_envio --#4
      ...
      if( v_parametros.tipo='interna') THEN
        ...
        IF((v_parametros.persona_destino is NULL OR v_parametros.persona_destino = '') and --#4
        ...
        IF( v_parametros.tipo='interna') THEN
         ...
         ELSE
            ...
            set
                ...
                id_persona= NULL,--v_parametros.id_persona_destino, --#4
                ...
                --id_clasificador = v_parametros.id_clasificador, --#4
                mensaje = v_parametros.mensaje,
                persona_destino = v_parametros.persona_destino --#4
            where id_correspondencia = v_parametros.id_correspondencia;
          END IF;
    ...
    begin
     ...
     IF EXISTS( SELECT 1
      ...
      IF (v_parametros.id_institucion_remitente is null) THEN
      	v_origen = v_parametros.persona_remitente;
      ELSE
      	SELECT insti.nombre
        into v_origen
      ...
      insert into corres.tcorrespondencia(estado, estado_reg,
                    ...
                    --id_clasificador, --#4
                    nro_paginas, otros_adjuntos, cite,
                    origen, fecha_creacion_documento,
                    --persona_firma,
                    tipo_documento,
                    persona_remitente --#4 MCGH
                    )
